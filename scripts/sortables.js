var sortable = (function () {
              ...
              (function (r, o) {
                ...
                0 === r.buttons &&
                  v(e.children, E(e).getConfig("items")).forEach(function (e) {
                    var t, n;
                    e === r.target || e.contains(r.target)
                      ? (t = e.classList).add.apply(t, o)
                      : (n = e.classList).remove.apply(n, o);
                  });
      ...
      /serialize/.test(a)
        ...
        : (e.forEach(function (s) {
            ...
            ["connectWith", "disableIEFix"].forEach(function (e) {
              ...
              (h = Object.assign({}, M, E(s).config, h)),
              (E(s).config = h),
              d(s, "opts", h),
              (s.isSortable = !0),
              k(s);
            ...
            (E(s).placeholder = u(s, e, h.placeholderClass)),
              d(s, "items", h.items),
              h.acceptFrom
                ? d(s, "acceptFrom", h.acceptFrom)
                : h.connectWith && d(s, "connectWith", h.connectWith),
              B(s),
              l(t, "role", "option"),
                  ...
                  (O = v(n.children, h.items)),
                    ...
                    n.dispatchEvent(
                      new CustomEvent("sortstart", {
                        detail: {
                          origin: { elementIndex: _, index: Y, container: S },
                          item: H,
                          originalTarget: t,
                        },
                      })
              ...
              i(s, "dragenter", function (e) {
                ...
                r &&
                  r !== P &&
                  ((z = v(r.children, d(r, "items")).filter(function (e) {
                    ...
                    e.currentTarget.contains(t) ||
                      ...
                      r.dispatchEvent(
                        new CustomEvent("sortleave", {
                          detail: {
                            origin: { elementIndex: _, index: Y, container: r },
                            item: H,
                            originalTarget: n,
                          },
                        })
                ...
                if (H) {
                  H.classList.remove(h.draggingClass),
                    ...
                    "true" === H.getAttribute("aria-copied") &&
                      ...
                      H.remove(),
                    void 0 !== H.oldDisplay &&
                      ((H.style.display = H.oldDisplay), delete H.oldDisplay);
                ...
                if (D(s, H.parentElement)) {
                  ...
                  if (t) {
                    ...
                    var n = E(s).placeholder,
                      ...
                      a = v(o.children, d(o, "items")).filter(function (e) {
                        return e !== n;
                      }),
                      i = b(
                        H,
                        Array.from(H.parentElement.children).filter(function (
                          e
                        ) {
                          return e !== n;
                        })
                  ...
                  } else d(H, "dropped", "false");
                }
              });
            var o = c(function (t, e, n, r) {
                if (H)
                  if (
                    ...
                    if (I < o || A < a) {
                      ...
                      if (
                        i < l &&
                        (("vertical" === h.orientation && r < c) ||
                          ("horizontal" === h.orientation && n < f))
                      )
                        return;
                      if (
                        l < i &&
                        (("vertical" === h.orientation && c + o - s < r) ||
                          ("horizontal" === h.orientation && f + a - d < n))
                      )
                        return;
                    }
  ...
  return (
    ...
    (U.__testing = {
      ...
      removeItemEvents: W,
      removeItemData: q,
      removeSortableData: F,
      removeContainerEvents: N,
    }),
    U
  );
})();
