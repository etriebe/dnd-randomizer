class Encounter{
    ...
    async prepareData(){
        for(let creature of this.data){
            ...
            if(!actor){
                ...
                await game.actors.importFromCompendium(compData.compendium, compEntry._id, {})
    ...
    validate(){
        for(let creature of this.data){
            if(!game.actors.getName(creature.name) && !Encounter.getCompendiumEntryByName(creature.name))
                return false;
        }
        return this;
    }
